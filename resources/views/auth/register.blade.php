...
<head>
  ...
  <title>InnovaMk | Página de Registro</title>
...
<body class="gray darken-4">
  ...
  @if (count($errors) > 0)
    ...
    <div class="col s12 z-depth-4 card" style="width: 25rem">
      <div class="card-header center white-text"; style="border-bottom: 1px solid red; background-color: #3949ab; height: 60px; padding-top: 20px">
          <h2 class="" style="font-size: 30px;">INNOVA<i>Mk</i></h2>                              
        </div>
      ...
      <!--      <h6><i>Por su seguridad no revele su usuario y contraseña a terceros</i></h6>   -->
        ...
        <div class="row">
          ...
          <div class="input-field col s12">
            <p class="margin center medium-small sign-up">Ya tienes una cuenta? <a href="{{ url('/') }}">Ingresar</a></p>
          </div>
        </div>
      </form>
    </div>

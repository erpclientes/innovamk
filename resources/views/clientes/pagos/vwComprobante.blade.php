...
<div id="app-5">
  ...
  <div class="row" >
      ...
      <div class="card">
        ...
        <div class="row card-header sub-header">
          <div class="col s12 m12">
            ...
            <a href="{{url('/registrar-pagos')}}" class="btn-floating right waves-effect waves-light grey lighten-5 tooltipped" href="#!" data-activates="dropdown2" data-position="top" data-delay="500" data-tooltip="Regresar">
            <i class="material-icons " style="color: #424242">keyboard_tab</i></a>            
          </div>
        </div>   
        @include('clientes.pagos.addPago')
    ...
    <br>      
          <div class="col s12 m12 l12">
            @if(!is_null($datos->glosa) and $datos->glosa != '')
            <div class="card-alert card purple" style="margin-left: 15px; margin-right: 15px">
                <div class="card-content white-text">
                  <p>OBSERVACIÓN : {{$datos->glosa}}.</p>
                </div>
            </div>
            @endif
            ...
            <div class="card white" style="margin-left: 15px; margin-right: 15px">
                                            <div class="card-content">
                                                <div class="row">
                                                  ...
                                                  @elseif($datos->idestado == "AN")    
                                                  <div class="input-field col s12 s12 m6 l3 right-align">
                                                    <div class="chip center-align grey accent-2 white-text" style="width: 100%">
                                                      <b>estado: ANULADO</b>
                                                      <i class="material-icons mdi-navigation-close"></i>
                                                    </div>
                                                  </div> 
              ...
              <div class="card-content">
                ...
                <div class="col s12 m6 l6">
                  ...
                  <div class="input-field col s12">
                    ...
                    <textarea disabled id="descripcion" name="descripcion" class="materialize-textarea" rows="6" lenght="200" maxlength="200" style="height: 6rem;" {{ ($datos->idestado == 'EM')? ''  : 'disabled' }}>{{$datos->glosa}}</textarea>
            ...
            <div class="col s12 m6 l5">
              <div class="card">
                <div class="card-content">
                  ...
                  <div class="input-field col s12  m6 l6">                    
                    <input id="descuento" name="descuento" type="text" maxlength="40" value="{{$datos->descuento}}" disabled >
...
@section('script')
  ...
  @include('clientes.pagos.scripts.addPago')

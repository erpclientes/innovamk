        ...
        <nav class="navbar-color" style="background-color: #33AFE8">
          <div class="nav-wrapper">
            <div class="header-search-wrapper hide-on-med-and-down sideNav-lock">
              ...
              <input type="text" name="Search" class="header-search-input z-depth-2" placeholder="Buscar en InnovaWifi" />
            </div>
            <ul class="right hide-on-med-and-down">
              ...
              <li>
                <a href="javascript:void(0);" class="hide waves-effect waves-block waves-light notification-button" data-activates="notifications-dropdown">
            ...
            <ul id="profile-dropdown" class="dropdown-content">
              <li><a href="{{url('usuario/mostrar')}}/{{Auth::user()->id}}" style="color: black">

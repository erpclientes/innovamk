                        ...
                        <div class="card-content">
                            ...
                            <div class="row">
                              <div class="input-field col s12 m6 l6 ">
                                ...
                                <input id="idzona" name="idzona" type="text" value=" {{ $data->id }}" data-error=".errorTxt1" maxlength="3" onkeyup="mayus(this);">
                              ...
                              <div class="input-field col s12 m6 l6">
                                ...
                                <input id="color" value="{{ $data->color }}" name="color" type="text" readonly="readonly">

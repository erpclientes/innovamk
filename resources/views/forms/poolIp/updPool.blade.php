<div id="updIpPool" class="modal modal-fixed-footer" style="height: 100%; overflow: hidden;">
              <div class="modal-content" style="padding: 0px; overflow-y: disabled; height: 300%; background-color: #f9f9f9">
                                  
                                  <div class="card" style="position: fixed; width: 100%; z-index: 2">                 
                                    <div class="card-header">                    
                                      <i class="fa fa-table fa-lg material-icons">receipt</i>
                                      <h2>ACTUALIZAR POOL</h2>
                                    </div>
                                  </div>
                                  ...
                                  <div class="row card-header sub-header" style="margin-top: 3.15rem; margin-left: 0rem; margin-right: 0rem; position: fixed; width: 100%; z-index: 3">
                                        <div class="col s12 m12">                         
                                          <button id="updPool" class="btn-floating waves-effect waves-light grey lighten-5 tooltipped" type="submit" name="action" data-position="top" data-delay="500" data-tooltip="Guardar">
                                  ...
                                  <form id="frmUpdPool" accept-charset="UTF-8" enctype="multipart/form-data" style="margin-top: 70px" >
                                  <div class="row cuerpo" style="margin-left: 0.5rem; margin-right: 0.5rem; padding-top:55px; z-index: 1">   
                                    <input type="hidden" id="u_codigo" name="codigo">  
                                            ...
                                            <div class="card-content">
                                                <div class="row">
                                                  <div class="col s12 m3 l4">
                                                    ...
                                                    <select class="browser-default" id="u_idrouter" name="idrouter"> 
                                                  ...
                                                  <div class="input-field col s12 m3 l4">
                                                    ...
                                                    <input id="u_descripcion" name="descripcion" type="text" data-error=".errorTxt2">
                                                  ...
                                                  <div class="input-field col s12 s12 m4 l4 right-align">
                                                    <div class="chip center-align teal accent-4 white-text" style="width: 90%">
                                            ...
                                            <div class="card-content">                                               
                                              ...
                                              <div class="row">
                                                <div class="input-field col s12 m6 l6">
                                                  <i class="material-icons prefix active">label_outline</i>
                                                  <input id="u_ip_inicial" name="ip_inicial" type="text" data-error=".errorTxt2">
                                                  <label for="ip_inicial">Ip inicial</label>
                                                  <div id="error2" style="color: red; font-size: 12px; font-style: italic;"></div>
                                                </div>      
                                                <div class="input-field col s12 m6 l6">
                                                  <i class="material-icons prefix active">label_outline</i>
                                                  <input id="u_ip_final" name="ip_final" type="text" data-error=".errorTxt2">
                                                  <label for="ip_final">Ip final</label>
                                                  <div id="error2" style="color: red; font-size: 12px; font-style: italic;"></div>
                                                </div>   
                                                <div class="input-field col s12 m6 l6">
                                                  <i class="material-icons prefix">mode_edit</i>
                                                  <textarea id="u_glosa" name="glosa" class="materialize-textarea" style="height: 120px;"></textarea>

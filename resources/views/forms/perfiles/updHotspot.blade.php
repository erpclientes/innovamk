                                            ...
                                            <div class="card-content">                                               
                                              ...
                                              <div class="row">
                                                ...
                                                <div class="input-field col s12 m6 l6">
                                                  ...
                                                  <input id="hu_nalternativo" name="hu_nalternativo" type="text" data-error=".errorTxt2" value=" ">
                                                  <label for="hu_nalternativo">Nombre alternativo</label>
                                                ...
                                                <div class="input-field col s12 m6 l6">
                                                  <i class="material-icons prefix">label_outline</i>
                                                  <input id="hu_users" name="hu_users" type="text" value="1">
                                                  <label for="hu_users">Usuarios compartidos</label>
                                                  <div id="h_error2" style="color: red; font-size: 12px; font-style: italic;"></div>
                                                </div>   
                                                <div class="input-field col s12 m6 l6">
                                                  <i class="material-icons prefix">label_outline</i>
                                                  <input id="hu_tiempo" name="hu_tiempo" type="text" value=" ">
                                                  <label for="hu_tiempo">Tiempo de sesión</label>
                                                  <div id="h_error2" style="color: red; font-size: 12px; font-style: italic;"></div>
                                                </div>      
                                                <div class="input-field col s12 m6 l6">

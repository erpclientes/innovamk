<script type="text/javascript">
    ...
    $('#hu_update').click(function(e){
      ...
      $.ajax({
           ...
           data:{
              ...
              nalternativo:$("input[name=hu_nalternativo]").val(),
              ...
              users:$("input[name=hu_users]").val(),
              tiempo:$("input[name=hu_tiempo]").val()
           },
           ...
           success:function(data){
              ...
              if ( data[0] == "error") {
                ...
                "</td>"+
                "<td class='center'>"+
                  "<a href='{{ url('/perfil/hotspot/mostrar') }}/"+ obj[0]['idperfil'] +"' class='btn-floating waves-effect waves-light grey lighten-5 tooltipped' data-position='top' data-delay='500' data-tooltip='Ver'><i class='material-icons' style='color: #7986cb'>visibility</i></a>"+                                     
                  " <a href='#confirmacion"+ obj[0]['idservicio'] +"' class='btn-floating waves-effect waves-light grey lighten-5 tooltipped modal-trigger' data-position='top' data-delay='500' data-tooltip='Eliminar'><i class='material-icons' style='color: #dd2c00'>remove</i></a>"+
                  " <a href='#p_confirmacion2"+ obj[0]['idperfil'] +"' class='btn-floating waves-effect waves-light grey lighten-5 tooltipped modal-trigger' data-position='top' data-delay='500' data-tooltip='Desabilitar'><i class='material-icons' style='color: #757575 '>clear</i></a>"+
                "</td>"
                );
                //alert(data.success);
    ...
    @foreach ($hotspot as $val)
      $(document).on('click','#updHotspot{{$val->idperfil}}', function(){
        ...
        $("#hu_nalternativo").val($(this).data('nalternativo'));
        ...
        $("#hu_users").val($(this).data('users'));
        $("#hu_tiempo").val($(this).data('tiempo'));

<script type="text/javascript">
   //----------------------GRABAR HOTSPOT-----------------------------------
    $("#h_add").click(function(e){
        ...
        var nalternativo = $("input[name=h_nalternativo]").val();
        ...
        var users = $("input[name=h_users]").val();
        var tiempo = $("input[name=h_tiempo]").val();
        ...
        $.ajax({
           ...
           success:function(data){
              ...
              if ( data[0] == "error") {
                ...
                "</td>"+
                "<td class='center'>"+
                  "<a href='{{ url('/perfil/mostrar') }}/"+ obj[0]['idperfil'] +"' class='btn-floating waves-effect waves-light grey lighten-5 tooltipped' data-position='top' data-delay='500' data-tooltip='Ver'><i class='material-icons' style='color: #7986cb'>visibility</i></a>"+                                     
                ...
                setTimeout("location.href = {{ url('/perfiles') }}",4000);
              }             

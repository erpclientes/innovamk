                                              ...
                                              <div class="row"> 
                                                <div class="col s12 m6 l6">
                                                  <label for="h_perfil">Perfil Mikrotik</label>
                                                    <select class="browser-default" id="h_perfil" name="h_perfil" > 
                                                ...
                                                <div class="input-field col s12 m6 l6">
                                                  ...
                                                  <input id="h_name" name="h_name" type="text" value=" ">
                                                ...
                                                <div class="input-field col s12 m6 l6">
                                                  ...
                                                  <input id="h_precio" name="h_precio" type="number">
                                                  <label for="h_precio">Precio</label>
                                                  <div id="h_error3" style="color: red; font-size: 12px; font-style: italic;"></div>
                                                </div>   
                                                <div class="input-field col s12 m6 l6">
                                                  <i class="material-icons prefix active">label_outline</i>
                                                  <input id="h_nalternativo" name="h_nalternativo" type="text" value=" ">
                                                  <label for="h_nalternativo">Nombre alternativo</label>
                                                  <div id="h_error2" style="color: red; font-size: 12px; font-style: italic;"></div>
                                                </div>      

                                                <div class="input-field col s12 m6 l6">
                                                  <i class="material-icons prefix">clear_all</i>
                                                  <input id="h_dsc_perfil" name="h_dsc_perfil" type="text" disabled value=" ">
                                                  <label for="h_dsc_perfil">Desc. Perfil</label>
                                                  <div id="h_error5" style="color: red; font-size: 12px; font-style: italic;"></div>
                                                </div> 
                                                <div class="input-field col s12 m6 l6">
                                                  <i class="material-icons prefix">label_outline</i>
                                                  <input id="h_users" name="h_users" type="text" value="1">
                                                  <label for="h_users">Usuarios compartidos</label>
                                                  <div id="h_error2" style="color: red; font-size: 12px; font-style: italic;"></div>
                                                </div>   
                                                <div class="input-field col s12 m6 l6">
                                                  <i class="material-icons prefix">label_outline</i>
                                                  <input id="h_tiempo" name="h_tiempo" type="text" value=" ">
                                                  <label for="h_tiempo">Tiempo de sesión</label>
                                                  <div id="h_error2" style="color: red; font-size: 12px; font-style: italic;"></div>
                                                </div>     
                                                <div class="input-field col s12 m6 l6">
                                                  <i class="material-icons prefix">cloud_upload</i>
                                                  <input id="h_vsubida" name="h_vsubida" type="text" value=" ">
                                                ...
                                                <div class="input-field col s12 m6 l6">
                                                  ...
                                                  <input id="h_vbajada" name="h_vbajada" type="text" value=" ">

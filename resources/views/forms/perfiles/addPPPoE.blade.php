                                            ...
                                            <div class="card-content" style="padding-top: 4px">                                               
                                              ...
                                              <div class="row">
                                                ...
                                                <div class="input-field col s12 m6 l6">
                                                  ...
                                                  <input id="p_name" name="p_name" type="text" data-error=".errorTxt2" value=" ">
                                                ...
                                                <div class="col s12 m6 l6">
                                                  <label for="p_remote_address">Remote Address</label>
                                                    <select class="browser-default" id="p_remote_address" name="p_remote_address" data-error=".errorTxt1" > 
                                                ...
                                                <div class="input-field col s12 m6 l6">
                                                  <i class="material-icons  prefix">clear_all</i>
                                                  <input id="p_local_address" name="p_local_address" type="text" data-error=".errorTxt3" disabled value=" ">
                                                  <label for="p_local_address">Dirección local</label>                                                  
                                                </div>        
                                                <div class="input-field col s12 m6 l6">
                                                  <i class="material-icons  prefix">cloud_upload</i>
                                                  <input id="p_vsubida" name="p_vsubida" type="text" data-error=".errorTxt4" value=" ">
                                                ...
                                                <div class="input-field col s12 m6 l6">
                                                  ...
                                                  <input id="p_vbajada" name="p_vbajada" type="text" data-error=".errorTxt5" value=" ">

...
@include('forms.perfiles.scripts.hotspot.exportar')
@include('forms.perfiles.scripts.hotspot.importar')
@include('forms.perfiles.scripts.hotspot.validacion')
...
@include('forms.perfiles.scripts.pppoe.exportar')
@include('forms.perfiles.scripts.pppoe.importar')

@include('forms.pcq.scripts.pcq')
@include('forms.pcq.scripts.addPCQ')
@include('forms.pcq.scripts.updPCQ')
@include('forms.pcq.scripts.importar')
@include('forms.pcq.scripts.exportar')
@include('forms.pcq.scripts.habilitar')
@include('forms.pcq.scripts.desabilitar')
@include('forms.pcq.scripts.delPCQ')

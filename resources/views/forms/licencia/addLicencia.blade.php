                              ...
                              <div class="col s12 m6 l6">
                                ...
                                <select class="browser-default" id="idtipo" name="idtipo" required>
                                  ...
                                  @foreach($tipo as $datos)
                                    <option value="{{$datos->idtipo}}">{{"($datos->idtipo)"." ".$datos->descripcion}}</option>
                                  @endforeach
                                </select>
                              </div>  
                              <div class="col s12 m6 l6">
...
@section('script')
  @include('forms.licencia.scripts.generarLicencia')
  @include('forms.licencia.scripts.addLicencia')
@endsection

              ...
              <div class="  col s12 m3 l3">
                <label for="zonas" >ZONAS</label>
                  <select class="browser-default" id="zonas" name="zonas" required>
                    ...
                    @foreach($zonas as $fp)
                    <option id="zonas" value="{{$fp->id }}" {{ $fp->id== $valor->idZona ? "selected" : "" }}>{{$fp->nombre}}</option>
                    @endforeach
                  </select> 
                  <div class="errorTxt1" id="error1" style="color: red; font-size: 12px; font-style: italic;"></div>
              </div>
                        ...
                        <div class="card-content">
                          ...
                          <div class="row">                            
                            ...
                            <div class="input-field col s12 m6 l6">
                              ...
                              <input id="fecha_ingreso" class="datepicker" name="fecha_ingreso" type="text" data-error=".errorTxt3" value="{{date_format(date_create($valor->fecha_ingreso),'d/m/Y')}}">
                            ...
                            <div class="input-field col s12 m6 l6">
                              ...
                              <input id="latitudF" name="latitudF" type="text" value="{{$valor->latitud}} " readonly="readonly">
                              <label for="latitudF">latitud</label>
                            </div>
                            <div class="input-field col s12 m6 l6">
                              <i class="material-icons prefix">maps_local</i>
                              <input id="longitudF" name="longitudF" type="text" value="{{$valor->longitud}} " readonly="readonly" >
                              <label for="longitudF">longitud</label>
                            </div>
                            <div class="input-field col s12 m6 l12">
                              <i class="material-icons prefix">room</i>
                              <input id="direccion"  readonly="readonly" name="direccion" type="text" value="{{$valor->direccion}} ">
                            ...
                            <div class="col s12  m6 l12"> 
                              <a type="button" class="waves-effect waves-light btn modal-trigger gradient-45deg-indigo-blue col s12" href="#modalUpdate"   style="height: 44px; letter-spacing: .5px; padding-top: 0.3rem;"   >Actualizar Dirección</a>
...
@section('script')
  ...
  @include('forms.equipos.scripts.actualizarUbicacion')  

                          ...
                          <table id="lstComprobante" class="responsive-table display tabla" cellspacing="0">
                               ...
                               <?php
                                ...
                                <tr id="fac{{$valor->codigo}}">                                  
                                     ...
                                     <td   >  <i class="material-icons  prefix active">attach_money</i> <input id="total" class="total1{{$valor->codigo}}" style="width: 50%;" name="total" type="text" disabled="" value="{{$valor->total}}"></td>
                                     <td class="center">
                                     ...
                                     <td class="center" style="width: 9rem">
                                      ...
                                      <a href="#vwNewConcepto{{$valor->codigo}}" id="newComprobante" class="tooltipped modal-trigger" data-position="top" data-delay="500" data-tooltip="Agregar concepto manual"  >
                                   ...
                                   @include(' forms.comprobante.cliente.modalConceptoManual')
                                  <?php }} ?>
                               </tbody>
                            </table>
                          </div>                

          ...
          <div class="card white">
            <div class="card-content">
              <div class="row" style="padding-top: 15px">
                ...
                <div class="input-field col s12 m6 l2">
                  <input id="subtotal_neto" name="subtotal_neto" class="subtotal_neto2" type="text" disabled="" value="{{$valor->subtotal_neto}}">
                ...
                <div class="input-field col s12 m6 l2">
                  ...
                  <input id="total" class="total2" name="total" type="text" disabled="" value="{{$valor->total}}">

        ...
        <div class="card gradient-45deg-purple-deep-orange gradient-shadow min-height-100 white-text">
          <div class="padding-4">
            <div class="col s7 m7">
              ...
              <p>Total de recurrencia</p>
            </div>
            <div class="col s5 m5 right-align">
              <h4 class="mb-0">+{{$concurrencia}}</h4>
              <p class="no-margin"></p>
              <p></p>
            </div>
          </div>
        ...
        <div class="card gradient-45deg-green-teal gradient-shadow min-height-100 white-text">
          <div class="padding-4">
            <div class="col s7 m7">
              ...
              <p>Total descarga datos</p>
            </div>
            <div class="col s5 m5 right-align">
              <h4 class="mb-0">{{$descarga}}</h4>
              <p class="no-margin">megas</p>
              <p></p>
            </div>
          </div>
        </div>
        ...
        <div class="card gradient-45deg-indigo-light-blue gradient-shadow min-height-100 white-text">
          <div class="padding-4">
            <div class="col s7 m7">
              ...
              <p>total subida datos</p>
            </div>
            <div class="col s5 m5 right-align">
              <h4 class="mb-0">{{$subida}}</h4>
              <p class="no-margin">megas</p>
              <p></p>
            </div>
          </div>
...
@section('script')
  @include('forms.clientes2.scripts.scripts')
@endsection

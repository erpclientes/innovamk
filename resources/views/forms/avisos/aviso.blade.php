...
@section('titulo','Mantenedor de Avisos')
  ...
  <div class="col s12 m12 l8 offset-l2">
                ...
                <div class="card">
                  <div class="card-header">                    
                    ...
                    <h2>Mantenedor de Aviso</h2>
                  </div>
                 <form class="formValidate right-alert" id="formAviso" method="POST" accept-charset="UTF-8" enctype="multipart/form-data">
                  <div class="card-header" style="height: 50px; padding-top: 5px; background-color: #f6f6f6">
                        <div class="col s12 m12">
                          ...
                          <a href="{{ url('/aviso') }}" target="_blank" class="btn-floating waves-effect waves-light grey lighten-5 tooltipped" data-position="top" data-delay="500" data-tooltip="Ver prototipo página">
...
@section('script')
  @include('forms.avisos.scripts.updAviso')  
@endsection

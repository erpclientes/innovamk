        ...
        <div class="row">
          <div class="col s12 m10 l10 offset-m1 offset-l1">
            <div class="card-panel z-depth-5" id="pagina-login" style=" padding: 0">
              ...
              <div class="card-header center white-text red darken-3"; style="border-bottom: 1px solid; height: 60px; padding-top: 20px">
              ...
              <form action="{{ url('/login') }}" method="post" style="padding: 10px">
                ...
                <div class="row">
                  <div class="input-field col s12 center">              
                    ...
                    <center>  
                        <span class="btn btn-secondary btn-block red darken-4" style="width: 25rem;">Atte. Gerencia</span> 

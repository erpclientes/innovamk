            ...
            <div id="card-stats">
              ...
              <div class="row">
                ...
                <div class="col s12 m6 l3">
                  <div class="card padding-4 animate fadeLeft">
                     <div class="col s5 m5">
                        <h5 class="mb-0" id="conexiones">{{$usu_suspendidos}}</h5>
                        <p class="no-margin">Clientes</p>
                        <p class="mb-0 pt-8"></p>
                     </div>
                     <div class="col s7 m7 right-align">
                        <i class="material-icons background-round mt-5 mb-5 gradient-45deg-indigo-light-blue gradient-shadow white-text">block</i>

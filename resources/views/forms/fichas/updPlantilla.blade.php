                          ...
                          <div class="card-content">
                              ...
                              <div class="row">
                                  ...
                                  <div class="col s12 m6 l5">
                                    ...
                                    <input id="descripcion" name="descripcion" type="text" value="{{$datos->descripcion}}" data-error=".errorTxt2" maxlength="100">
                                  </div>
                                  <div class="input-field col s12 m6 l7">                                  
                                  ...
                                  <div class="col s12 m6 l5">
                                    ...
                                    <p class="range-field">
                                      <input type="range" name="size_precio" id="size_precio" min="10" max="30" value="{{$datos->size_precio}}" class="active"><span class="thumb"><span class="value"></span></span>
                                    </p>
                                  </div>      
                                  <div class="input-field col s12 m6 l7">                                  
                                  ...
                                  <div class="col s12 m6 l5">
                                    ...
                                    <input id="cfondo_cabecera" name="cfondo_cabecera"  type="text" value="{{$datos->cfondo_cabecera}}" data-error=".errorTxt2" maxlength="100">
                                  </div>      
                                  <div class="input-field col s12 m6 l7">                                  
                                  ...
                                  <div class="col s12 m6 l5">
                                    ...
                                    <input id="cfondo_cuerpo" name="cfondo_cuerpo"  type="text" value="{{$datos->cfondo_cuerpo}}" data-error=".errorTxt2" maxlength="100">
                                  </div>      
                                  <div class="input-field col s12 m6 l7">                                  
                                  ...
                                  <div class="col s12 m6 l5">
                                    ...
                                    <input id="cfondo_footer" name="cfondo_footer"  type="text" value="{{$datos->cfondo_footer}}" data-error=".errorTxt2" maxlength="100">
                                  </div>      
                                  <div class="input-field col s12 m6 l7">                                  
                                  ...
                                  <div class="col s12 m6 l5">
                                    ...
                                    <input id="texto1" name="texto1"  type="text" value="{{$datos->texto1}}" data-error=".errorTxt2" maxlength="100">
                                  </div>      
                                  <div class="input-field col s12 m6 l7">                                  
                                  ...
                                  <div class="col s12 m6 l5">
                                    ...
                                    <input id="texto2" name="texto2" type="text" value="{{$datos->texto2}}" data-error=".errorTxt2" maxlength="100">
                                  </div> 
                                  <div class="input-field col s12 m6 l7">                                  
                                  ...
                                  <div class="col s12 m6 l5">
                                    <label for="idmodelo">Tamaño píxeles</label>
                                    <p class="range-field">
                                      <input id="size_texto2" name="size_texto2" type="range" name="padding_top" min="10" max="30" value="{{$datos->size_texto2}}" class="active"><span class="thumb"><span class="value"></span></span>
                                    </p>
                                  </div>      
                              </div>

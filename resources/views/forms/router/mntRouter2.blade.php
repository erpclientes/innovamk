                    ...
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                      <div class="row">
                        <div class="input-field col s12 s12 m6 l6">
                          ...
                          <input id="idrouter" name="idrouter" type="text" onkeyup="mayus(this);" style="margin-bottom: 1px">
                          <label for="idrouter">Código Router*</label>
                          <div class="errorTxt1" style="color: red; font-size: 12px; font-style: italic; padding-left: 3rem;"></div>
                        </div>

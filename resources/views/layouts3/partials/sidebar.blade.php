    ...
    <aside class="sidenav-main nav-expanded nav-lock nav-collapsible sidenav-light sidenav-active-square">
      ...
      <ul class="sidenav sidenav-collapsible leftside-navigation collapsible sidenav-fixed" id="slide-out" data-menu="menu-navigation" data-collapsible="menu-accordion">
                ...
                <li class="no-padding">
                  <ul class="collapsible" data-collapsible="accordion">                
                    <li class="bold">
                      <a class=" waves-effect waves-cyan" href="{{url('/servicio')}}/{{Auth::user()->id}}">
                        <i class="material-icons">cast</i>
                        <span class="nav-text">Servicio de Internet</span>
                      </a>                  
                    </li>
                  </ul>
                </li>            
                <li class="no-padding">
                  <ul class="collapsible" data-collapsible="accordion">                
                    <li class="bold">
                      <a class=" waves-effect waves-cyan" href="{{ url('/registrar-pagos') }}">
                ...
                <li class="bold">
                  <a class=" waves-effect waves-cyan" href="{{ url('#') }}">
                    ...
                    <span class="nav-text">Registrar Incidencia</span>
                  </a>                  
                </li>
                <li class="bold">
                  <a class=" waves-effect waves-cyan" href="{{ url('/pagos/historial') }}">
